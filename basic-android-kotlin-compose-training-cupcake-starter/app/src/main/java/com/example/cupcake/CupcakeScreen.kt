...
private fun shareOrder(context: Context, subject: String, summary: String) {
    ...
    context.startActivity(
        // The second parameter is the subject of the email or some text.
...
fun CupcakeApp(
    ...
    Scaffold(topBar = {
        ...
        // This is the host for routing in the app
        NavHost(
            navController = navController,
            startDestination = CupcakeScreen.Start.name,
            modifier = Modifier.padding(innerPadding)
        ) { // Define where the app goes here.

            // TODO(etagaca):s Continue this.
            ...
            composable(route = CupcakeScreen.Flavor.name) { // Get context to determine the string for the resource ID.
