...
fun ReplyDetailsScreen(
    ...
    Box(modifier = modifier) {
        LazyColumn(
            ...
            item {
                // Check if we are in mobile view to show back button
                if (isFullScreen) {
...
private fun ReplyEmailDetailsCard(
    ...
    Card(
        ...
        Column(
            ...
            val emailBodyContentDescription = stringResource(email.body)
            Text(
                text = stringResource(email.body),
                style = MaterialTheme.typography.bodyLarge,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
                modifier = Modifier.testTag(emailBodyContentDescription)
            )
